        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-8">
            <div className="flex flex-col md:flex-row md:justify-between mb-4">
              ...
              <Link to='/signup'><button className="text-xl md:text-2xl font-bold text-gray-500">
                Sign up
              </button></Link>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center">
                <a href="#" className="text-sm text-gray-600 mb-2 sm:mb-0">
                  Forgot password
                </a>
            ...
            <div className="mt-8 text-center">
              ...
              <div className="mt-6 flex justify-center space-x-4 sm:space-x-6">
                <button className="p-2 sm:p-3 border rounded-full">
                  <FcGoogle className="text-[#EC3D2F] w-6 h-6" />
                </button>
                <button className="p-2 sm:p-3 border rounded-full">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 flex justify-center items-center">
            <img
              ...
              alt="Electronics"
              className="w-[200%] h-[150%] md:w-[150%] md:h-[100%] max-w-xs md:max-w-md lg:max-w-lg object-cover"
            />
          </div>
        </div>
      </div>
